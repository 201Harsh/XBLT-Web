...
const GenHeader = () => {
  return (
    <div className="fixed top-6 left-0 right-0 z-50 flex justify-center px-4">
      <header className="rounded-full border border-white/10 bg-[#0A0A0A]/80 backdrop-blur-xl flex items-center px-2 py-2 shadow-[0_8px_32px_rgba(0,0,0,0.8)] transition-all hover:border-[#E2F609]/30">
        <Link
          href="/"
